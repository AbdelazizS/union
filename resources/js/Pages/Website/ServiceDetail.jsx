    ...
    return (
        ...
        >
            ...
            <section className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-primary/5 to-background">
                <div className="container mx-auto">
                    <nav aria-label="Breadcrumb" className="flex flex-wrap items-center gap-1.5 text-sm text-muted-foreground mb-8">
                        ...
                        <ChevronRight className="h-3.5 w-3.5 flex-shrink-0" aria-hidden="true" />
                        <span className="text-foreground line-clamp-1" aria-current="page">{service.title}</span>
                    </nav>
                                    ...
                                    <Form {...testimonialForm}>
                                        <form onSubmit={testimonialForm.handleSubmit(onSubmitTestimonial)} className="space-y-6">
                                            ...
                                            <div className="flex items-center justify-between mb-8">
                                                <div className="flex items-center gap-2">
                                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep === 1 ? "bg-primary text-white" : "bg-primary/10 text-primary"
                                                        }`}>
                                                        1
                                                    </div>
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep === 2 ? "bg-primary text-white" : "bg-primary/10 text-primary"
                                                        }`}>
                                                        2
                                                    </div>
            ...
            <motion.div
                ...
                viewport={{ once: true, margin: "-100px" }}
                transition={{ duration: 0.6 }}
                className="mt-24 mb-12 container mx-auto px-4"
            >
